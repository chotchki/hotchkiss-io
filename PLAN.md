...
- [ ] BX.0 - Phase exit: blog posts show next/previous cards to adjacent posts; omitted at the ends; absent on /pages; live on prod
...
- [ ] BX.4 - Deploy beta → verify → tag vX.Y.Z (prod)
