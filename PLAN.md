...
- [ ] BV.0 - Phase exit: content pages render typeset math (KaTeX) + syntax-highlighted code; TeX/code source stays in the served HTML (no-JS/LLM-readable); live on prod
...
- [ ] BV.4 - Deploy: push main (beta) → verify → tag vX.Y.Z (prod)
